...
# Categorically commented out the RDD generics as they are all covered in the
# RDD R6 class.
#
...
# Categorically commenting out SDF methods since it's redundant with existing
